...
- <img src="https://github.com/89rat.png" height="14"/> [code402](https://github.com/89rat/m2m-exchange) - Machine-to-machine payments on x402 (HTTP 402): discover machine-payable APIs, probe live payment terms, register sellers, read analytics and invoices. Non-custodial USDC on Base — buyers pay per call, sellers settle direct to their own wallet.
